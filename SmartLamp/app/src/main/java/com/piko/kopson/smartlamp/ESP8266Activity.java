...
/**
 * Created by p.kopka on 1/11/16.
 */
public class ESP8266Activity extends ActionBarActivity implements View.OnClickListener {
    ...
    private class HttpRequestAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        public HttpRequestAsyncTask(Context context, String parameterValue, String ipAddress, String portNumber, String parameter)
        {
            ...
            alertDialog = new AlertDialog.Builder(this.context)
                    .setTitle("HTTP Response From: " + ipAddress + ":" + portNumber)
                    .setCancelable(true)
                    .create();
        ...
        protected Void doInBackground(Void... voids) {
            alertDialog.setMessage("(" + parameter + "=" + parameterValue + ") sent, waiting for reply from server...");
